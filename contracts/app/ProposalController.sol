...
contract ProposalController {
    ...
    function creatProposal(bytes32 _title, bytes32 _description, bytes32 _videoLink, bytes32 _documentsLink, uint _value) public returns(Proposal proposal) {
        proposal = new Proposal(msg.sender, _title, _description, _videoLink, _documentsLink, _value);
